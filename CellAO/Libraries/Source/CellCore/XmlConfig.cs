...
namespace Cell.Core
{
    ...
    public class XmlConfig
    {
        ...
        /// </summary>
        private string m_fname = "config.xml";
        ...
        public virtual void Save()
        {
            ...
            string path = Path.GetDirectoryName(m_fname);
            ...
            //and indentation
            using (TextWriter writer = new StreamWriter(m_fname, false, Encoding.UTF8))
            {
        ...
        public virtual void Assign(XmlConfig cfg)
        {
            m_fname = cfg.m_fname;
        }
        ...
        public virtual void Load(Type type)
        {
            ...
            using (XmlReader rdr = XmlReader.Create(m_fname))
            {
